  ...
  return (
    <div className="flex flex-col h-full">
      <div className="mb-6">
        ...
        <p className="text-sm text-text-secondary mt-1">Actualizá tu información personal.</p>
      </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-text-main flex items-center gap-1.5">
                ...
                Nueva Contraseña
                <span className="text-xs text-text-secondary font-normal">(dejar en blanco para no cambiar)</span>
              </label>
              <input
                type="password"
                name="password"
