...
export const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-surface border-r border-border h-screen flex flex-col transition-colors duration-300">
      <div className="p-6 flex items-center gap-3">
        <LogoSVG className="w-12 h-12 shrink-0 drop-shadow-sm" />
        <div>
